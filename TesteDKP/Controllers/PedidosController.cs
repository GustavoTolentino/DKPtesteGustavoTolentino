...
namespace TesteDKP.Controllers
{
    public class PedidosController : Controller
    {
        ...
        {
            var dbContext = _context.Pedidos.Include(p => p.IdClienteNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCliente,Nome,Valor")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdCliente,Nome,Valor")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
